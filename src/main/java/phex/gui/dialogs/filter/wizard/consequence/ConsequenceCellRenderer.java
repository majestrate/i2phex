 ...
 *  --- CVS Information ---
 *  $Id: ConsequenceCellRenderer.java 3362 2006-03-30 22:27:26Z gregork $
 */
...
{
    public ConsequenceCellRenderer()
    {
        super( );
    }
    ...
    {
        setText( (value == null) ? "" : ConsequenceVisualizer.buildCleanDisplayString( (Consequence)value) );
    }    
}
