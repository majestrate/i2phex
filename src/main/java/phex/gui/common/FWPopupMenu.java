 ...
 *  --- CVS Information ---
 *  $Id: FWPopupMenu.java 4363 2009-01-16 10:37:30Z gregork $
 */
...
public class FWPopupMenu extends JPopupMenu
{
    ...
    public FWPopupMenu(String name)
    {
        super(name);
    }
        ...
        boolean isToogleAction)
    {
        ...
        KeyStroke accelerator = (KeyStroke)action.getValue( FWAction.ACCELERATOR_KEY );
        if ( accelerator != null )
        {
